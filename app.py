...
client = motor.motor_asyncio.AsyncIOMotorClient("mongodb+srv://BlackChiney:PA55WORD@cluster0.goqr4lq.mongodb.net/?retryWrites=true&w=majority",tls=True, tlsAllowInvalidCertificates=True)
...
async def do_delete(id:str):
    deleted_tank = await db["tank"].delete_one({"_id": ObjectId(id)})
